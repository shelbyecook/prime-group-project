...
//             )}
//           </td>
//           <td>{this.props.spaces.fields['Space Name']}</td>
          ...
          <CardBody style={this.state.status ? openHeight : closedHeight}>
            <Row style={this.state.status ? openFade : closedFade}>
              ...
              <Col lg={5}>
                ...
                <p>
                  Address: {this.props.space.fields['Street Address']}{' '}
                  {this.props.space.fields.City},{' '}
                  {this.props.space.fields.State}
                </p>
                <hr />
                {/* <div style={{ width: '50%' }}>
                  {this.props.space.fields &&
                    this.props.space.fields['Speaker Photo'] &&
                    this.props.space.fields['Speaker Photo'][0] && (
                      <img
                        className="mt-2"
                        style={{
                          height: '100%',
                        ...
                        src={this.props.space.fields['Speaker Photo'][0].url}
